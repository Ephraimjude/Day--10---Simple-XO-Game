...
function gameOver(a) {
    var gameOverAlertElement = "<b>WINNER </b><br><br> Player " + span[a].dataset.player.toUpperCase() + ' Win !!! <br><br>' + restartButton;
